...
def ask_model():
    ...
    question_array = [
        "根據上述各則通知的內容，依序判斷每一則通知是否重要。(此為是非題，回答的內容只能為「是」或「否」，不需做任何說明)",
        "根據上述各則通知的內容，依序判斷每一則通知是否來自使用者身邊的人所傳的訊息。(此為是非題，回答的內容只能為「是」或「否」，不需做任何說明)",
        "根據上述各則通知的內容，依序判斷每一則通知是否提及發票。(此為是非題，回答的內容只能為「是」或「否」，不需做任何說明)",
        "根據上述各則通知的內容，依序判斷每一則通知是否存在驚嘆號。(此為是非題，回答的內容只能為「是」或「否」，不需做任何說明)"
    ]
