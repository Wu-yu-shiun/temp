...
def ask_model():
    ...
    questions = [
        "以下通知的內容對使用者來說是否重要？(一則通知做一次回答，回答只需一個字：是/否，請不要進一步說明)",
        "以下通知的內容是否和使用者身邊的人相關？(一則通知做一次回答，回答只需一個字：是/否，請不要進一步說明)",
        "判斷以下的通知是否來自於社交媒體？(一則通知做一次回答，回答只需一個字：是/否，請不要進一步說明)",
        "以下通知的內容是否有提及數字？(一則通知做一次回答，若有，回答只需呈現出現過的數字。若無，回答只需一個字：無，請不要進一步說明)",
    ]
