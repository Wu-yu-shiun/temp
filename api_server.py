...
def ask_model():
    ...
    questions = [
        "幫我逐一判斷每一則通知的內容是否重要？請用一個字「是」或「否」做簡答，請不要做其他說明。",
        "幫我逐一判斷每一則通知的內容是否和使用者身邊的人相關？請用一個字「是」或「否」做簡答，請不要做其他說明。",
        "幫我逐一判斷每一則通知的內容是否來自於社交軟體？請用一個字「是」或「否」做簡答，請不要做其他說明。",
        "幫我逐一判斷每一則通知的內容是否存在數字，若有，請用簡答的方式將所有數字列出，若無，請用一個字「無」做簡答，請不要做其他說明。",
    ]
